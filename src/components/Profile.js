  ...
  return (
    <>
      <div className="flex flex-col justify-between bg-white/20 px-4 py-4 overflow-hidden">
        <span className="font-cursive text-left text-fuchsia-500 text-3xl md:text-xl">{label}</span>
        <span className="text-white text-center font-medium text-xl md:text-lg">{value}</span>
      </div>
    </>
  );
}
